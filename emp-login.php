...
<?php
    ...
    if(isset($_POST['emp_login']))
    {
      ...
      $stmt -> bind_result($admin_email,$admin_pwd);//bind result
      $rs=$stmt->fetch();
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-danger">
              <div class="card-header"><img class=" " src="" alt="logo" width="{conf.logoWidth}" height="27"><span class="splash-description">Admin Login Panel</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer">&copy; 2023 - <?php echo date ('Y');?> Online Railway Reservation System | MD.JAHID HASAN JUDGE</div>
          </div>
        </div>
      </div>
    </div>
